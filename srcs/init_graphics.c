...
void	init_xpm_img(t_game *game)
{
	...
	tile_size = TILE_SIZE;
	game->noth_img.img = mlx_xpm_file_to_image(game->mlx, NORTH_IMG, &tile_size, &tile_size);
	game->south_img.img = mlx_xpm_file_to_image(game->mlx, SOUTH_IMG, &tile_size, &tile_size);
	game->east_img.img = mlx_xpm_file_to_image(game->mlx, EAST_IMG, &tile_size, &tile_size);
	game->west_img.img = mlx_xpm_file_to_image(game->mlx, WEST_IMG, &tile_size, &tile_size);
	check_img(game);
	init_addr(game);
}
